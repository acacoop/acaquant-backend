...
### P3 — Copiloto de Mesa
**Estado: v1.45 (2026-07-12) — 4 VISTAS EN SHADOW (admin): HOME, Renta Variable,
TRADING (+ el VIGÍA reactivo) y RENTA FIJA** · Tipo: copiloto contextual por
vista · Gate: `ia` + módulo RBAC de la vista

> El detalle fino del asistente (qué ve HOY, técnicas, changelog v1→v1.45)
...
- **2026-07-11/12 — P3 v1→v1.45: copiloto de mesa COMPLETO en shadow** (4

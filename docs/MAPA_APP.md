...
- **195 escriben** (POST/PUT/PATCH/DELETE); 332 son de solo lectura.
...
| `/api/back-office` | 65 | 37 | `back-office` · 32 rutas con gate extra | `back-office` |  |

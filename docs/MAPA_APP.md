...
<!-- AUTOGEN:resumen -->
- **558 endpoints** montados en `api.main.app`, en **31 routers**.
- **217 escriben** (POST/PUT/PATCH/DELETE); 341 son de solo lectura.
...
| `/api/ia` | 49 | 33 | `ia` · 48 rutas con gate extra | `ia` |  |

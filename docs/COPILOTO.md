...
| Ubicación del botón | `acaquant-web/src/components/header.tsx` (`VISTA_IA_POR_RUTA`) | Slot derecho del header (ex-TERMINAL) para HOME/RF/RV/Agro/Opciones. (La vista `ons` se eliminó el 2026-08-16 junto con la pantalla `/ons`.) Excepción: /trading monta el suyo in-view (cableado a tarjetas + vigía). |

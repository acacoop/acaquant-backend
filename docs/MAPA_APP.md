...
<!-- AUTOGEN:resumen -->
- **544 endpoints** montados en `api.main.app`, en **31 routers**.
- **209 escriben** (POST/PUT/PATCH/DELETE); 335 son de solo lectura.
...
| `/api/back-office/interbanking` | 20 | 14 | `back-office` · 17 rutas con gate extra | `back-office` |  |

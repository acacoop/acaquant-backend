...
| GET | `/api/titulos/flujos` | `TitulosAPI.FlujosAPI` | `ticker`, `curva`, `moneda_flujo` |
...
| `Trading.Curvas` + `Trading.BondMaster` | `TitulosAPI.FlujosAPI` | merge 2 fuentes, flujos normalizados, fechas→datetime | `flujos-titulos` |

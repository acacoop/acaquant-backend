...
- **Constantes globales y feature flags** viven en `config.py` (raíz): `TICKERS_EXTRA_PRECIOS`, `AP5_CONCEPTOS_ACTIVO_INTEGRADO`, etc. Env vars en `.env` local / systemd unit files en el Droplet (`MANAGER_EMAILS`, `DEFAULT_ROLE`, `POSTGRES_URI`).
...
| Operación, incidentes y telemetría | `RUNBOOK.md` |

---
id: scripts.backfill_es_cierre_operaciones
type: module
layer: scripts
repo: backend
tags: [module, scripts, backend]
path: scripts/backfill_es_cierre_operaciones.py
---

# scripts/backfill_es_cierre_operaciones

> Backfill del campo `es_cierre` (bool) en CashFlow.Operaciones.

**Archivo:** `scripts/backfill_es_cierre_operaciones.py`

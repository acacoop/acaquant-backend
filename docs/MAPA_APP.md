...
<!-- AUTOGEN:resumen -->
- **525 endpoints** montados en `api.main.app`, en **30 routers**.
- **193 escriben** (POST/PUT/PATCH/DELETE); 332 son de solo lectura.
...
| `/api/back-office/interbanking` | 8 | 4 | `back-office` · 6 rutas con gate extra | `back-office` |  |

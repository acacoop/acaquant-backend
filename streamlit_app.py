...
# Nombre corto para el selector (ej: "TX28")
...
# --- Header y selector de ticker ---
header_col, select_col = st.columns([3, 1])
with header_col:
    st.markdown("## 📈 ACAQuant | Mesa de Dinero")
with select_col:
    # Usamos session_state para que el rerun no resetee la selección

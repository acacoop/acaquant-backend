...
TAREAS: dict[str, dict] = {
    ...
    "asistente_renta_fija": {"tier": "flash", "max_tokens": 3000, "timeout_s": 120,
                             "usa_herramientas": True,
                             "para_que": "el asistente, RENTA FIJA: bonos, letras, ONs y sus curvas"},
    "asistente_renta_variable": {"tier": "flash", "max_tokens": 3000, "timeout_s": 120,
                                 "usa_herramientas": True,
                                 "para_que": "el asistente, RENTA VARIABLE: acciones y CEDEARs"},
    "asistente_fondos": {"tier": "flash", "max_tokens": 3000, "timeout_s": 120,
                         "usa_herramientas": True,
                         "para_que": "el asistente, FONDOS: los FCI"},
    "asistente_derivados": {"tier": "flash", "max_tokens": 3000, "timeout_s": 120,
                            "usa_herramientas": True,
                            "para_que": "el asistente, DERIVADOS: futuros y opciones"},
    "asistente_financiamiento": {"tier": "flash", "max_tokens": 3000, "timeout_s": 120,
                                 "usa_herramientas": True,
                                 "para_que": "el asistente, FINANCIAMIENTO: caución y tasas"},
    "asistente_dolares": {"tier": "flash", "max_tokens": 3000, "timeout_s": 120,
                          "usa_herramientas": True,
                          "para_que": "el asistente, DÓLARES: MEP, CCL, oficial, brechas"},
}

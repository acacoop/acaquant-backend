...
<!-- AUTOGEN:resumen -->
- **529 endpoints** montados en `api.main.app`, en **30 routers**.
...
| `/api/back-office/interbanking` | 12 | 8 | `back-office` · 10 rutas con gate extra | `back-office` |  |

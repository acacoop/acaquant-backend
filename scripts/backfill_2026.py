"""backfill_2026.py — rehace los snapshots de AuM de 2026 (ene, feb).
...
Marzo NO está: tiene snapshots diarios (no es un cierre mensual puro) y
falta el Excel de precios de marzo — se agrega cuando esté definido.
...
# (fecha_snapshot, JSON de precios). Cierres de mes de 2026.

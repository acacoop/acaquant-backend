...
def main() -> None:
    ...
    if ganadora is None:
        print()
        print(SEP)
        print("SIN OPERACIONES — y hay tres motivos posibles, no uno")
        print(SEP)
        print("  1. El método NO está habilitado para nuestro usuario → si arriba")
        print("     viste Code='401'. Es reclamo al proveedor (y es el MISMO que")
        print("     ya dio CurrencyList/ClosingProcesses).")
        print("  2. Ese día no hubo operaciones nuestras → si viste 'OK — 0")
        print("     operaciones'. Probá otra fecha con --fecha AAAAMMDD.")
        print("  3. Falta un parámetro obligatorio → si viste Code='404'. Es lo")

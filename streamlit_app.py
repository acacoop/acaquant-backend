...
# ==========================================
    ...
    # st.tabs() siempre registra sus paneles a nivel raíz, no se puede contener en st.empty().
    # Solución: limpiar _main (borra contenido de vistas con loop) y renderizar directo.
    # El elif garantiza que este bloque no corre cuando se cambia de vista.
    _main.empty()

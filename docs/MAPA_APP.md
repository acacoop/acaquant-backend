...
<!-- AUTOGEN:resumen -->
- **501 endpoints** montados en `api.main.app`, en **30 routers**.
- **176 escriben** (POST/PUT/PATCH/DELETE); 325 son de solo lectura.
...
| `/api/ia` | 18 | 11 | `ia` · 17 rutas con gate extra | `ia` |  |

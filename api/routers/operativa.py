...
from api.services.operativa_mep_sql import (
...
def listar_dia(
    ...
    """Operativas MEP del día UTC, con join a órdenes live + USD/MEP efectivo."""
...
def detalle_operativa(
    ...
    órdenes live y timeline de execution reports + REST snapshots."""

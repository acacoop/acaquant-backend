...
SIN modelo por ahora: CUATRO reglas DETERMINÍSTICAS (`core.clase_activo`)
...
from core.clase_activo import de_cartera, de_curva, de_derivado, de_fci, normalizar_nombre

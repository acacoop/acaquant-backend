...
| 10 | TEA de un corporativo HD distinta a la de 1816 **al mismo precio** | cuadro mal convertido, escala del flujo, o convención | `tasa_vs_1816` (17:30 ART; aviso, sin botón — se mira el cuadro en Manager). A mano: `scripts.diag_tea_corp_hd` |

    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "horizonte_dias": {"type": "INTEGER", "description": "Días a proyectar (default 0 = instantáneo). 365 = a 1 año."},
    ...
    # ─── REM (Relevamiento de Expectativas de Mercado, BCRA) ─────────────
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "periodo_hasta": {"type": "STRING", "description": "Filtro máximo de período ('YYYY-MM')."},
            },
        },
    },

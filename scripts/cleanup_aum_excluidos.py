...
def main() -> None:
    ...
    print(f"contrapartes (matcheo por id_cuenta):  {len(contrapartes_ids)}")
    print(f"contrapartes (matcheo por nombre):     {len(contrapartes_names)}")
    match = mongo_match_excluded(contrapartes_ids, contrapartes_names)

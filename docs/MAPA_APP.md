...
<!-- AUTOGEN:resumen -->
- **530 endpoints** montados en `api.main.app`, en **30 routers**.
...
| `/api/back-office/interbanking` | 13 | 9 | `back-office` · 11 rutas con gate extra | `back-office` |  |

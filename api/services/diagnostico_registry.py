...
PIEZAS: list[Pieza] = [
    ...
    Pieza("MERCADOS", "job", "licitaciones (mails 1816 → IA)", grupo="RENTA FIJA",
          unidad="jobs.licitaciones",
          cadencia="cada 30m · 10-14 UTC L-V", ventana="diario", umbral_s=int(3 * _D),
          run_tipo="licitaciones"),

...
<!-- AUTOGEN:resumen -->
- **543 endpoints** montados en `api.main.app`, en **31 routers**.
- **208 escriben** (POST/PUT/PATCH/DELETE); 335 son de solo lectura.
...
| `/api/back-office/interbanking` | 19 | 13 | `back-office` · 16 rutas con gate extra | `back-office` |  |

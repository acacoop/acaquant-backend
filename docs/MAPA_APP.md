...
<!-- AUTOGEN:resumen -->
- **526 endpoints** montados en `api.main.app`, en **33 routers**.
- **195 escriben** (POST/PUT/PATCH/DELETE); 331 son de solo lectura.

...
<!-- AUTOGEN:resumen -->
- **500 endpoints** montados en `api.main.app`, en **30 routers**.
- **175 escriben** (POST/PUT/PATCH/DELETE); 325 son de solo lectura.
...
| `/api/ia` | 17 | 10 | `ia` · 16 rutas con gate extra | `ia` |  |

...
docs/        # ARQUITECTURA.md (DOC MADRE: arquitectura/datos/estrategia/roadmap/plan SQL). Referencia operativa: API.md, MCP.md, MCP_TOOLS.md, MOTOR_VALUACIONES.md, RUNBOOK.md (operación/incidentes), SECRETS.md + SECURITY.md (seguridad), PARTNER_API*.md, GRUPOS.md, SEGMENTACION_PATRIMONIAL.md, HERRAMIENTAS.md (auto-gen). vault/ (cerebro Obsidian, auto-generado)
```

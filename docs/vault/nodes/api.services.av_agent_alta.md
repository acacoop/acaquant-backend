---
id: api.services.av_agent_alta
type: module
layer: api
repo: backend
tags: [module, api, backend]
path: api/services/av_agent_alta.py
---

# api/services/av_agent_alta

> api/services/av_agent_alta.py — E2: SIMULAR un alta antes de escribirla.

**Archivo:** `api/services/av_agent_alta.py`

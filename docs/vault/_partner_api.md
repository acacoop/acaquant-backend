...
- [[partner_api.pg]] — Conexión Postgres (Supabase) del partner_api — espejo SQL de `ACAPortfolio`.
- [[partner_api.ratelimit]] — Rate limiter del partner_api — slowapi, keyeado por IP del cliente.
- [[partner_api.routes]] — Endpoints de datos del partner_api — SOLO lectura del portfolio del proveedor.
...
- [[partner_api.store]] — partner_api/store.py — capa de datos SQL-native (decomiso Mongo).

...
- **Plataforma:** Manager (RBAC, diagnóstico, ingesta) y **el ASISTENTE** (`asistente/`, `docs/AvAgentAI.md`): grafo LangGraph de agentes por mundo, admin-only, en la tab LAB del AV AGENT. El copiloto viejo y el **MCP server** se borraron el 2026-08-28.

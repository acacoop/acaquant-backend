...
<!-- AUTOGEN:resumen -->
- **512 endpoints** montados en `api.main.app`, en **33 routers**.
- **192 escriben** (POST/PUT/PATCH/DELETE); 320 son de solo lectura.
...
| `/api/news` | 3 | 0 | — | — | ⚠️ |
| `/api/operaciones` | 57 | 9 | `operaciones` · 24 rutas con gate extra | `operaciones` |  |

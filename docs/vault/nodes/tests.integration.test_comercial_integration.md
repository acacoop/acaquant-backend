---
id: tests.integration.test_comercial_integration
type: module
layer: tests
repo: backend
tags: [module, tests, backend]
path: tests/integration/test_comercial_integration.py
---

# tests/integration/test_comercial_integration

> Tests de integración de la vista COMERCIAL — contra Atlas.

**Archivo:** `tests/integration/test_comercial_integration.py`

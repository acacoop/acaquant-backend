...
<!-- AUTOGEN:resumen -->
- **537 endpoints** montados en `api.main.app`, en **30 routers**.
- **205 escriben** (POST/PUT/PATCH/DELETE); 332 son de solo lectura.
...
| `/api/ia` | 42 | 28 | `ia` · 41 rutas con gate extra | `ia` |  |

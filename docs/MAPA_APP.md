...
<!-- AUTOGEN:resumen -->
- **516 endpoints** montados en `api.main.app`, en **32 routers**.
- **189 escriben** (POST/PUT/PATCH/DELETE); 327 son de solo lectura.
...
| `/api/news` | 3 | 0 | — | — | ⚠️ |
| `/api/operaciones` | 55 | 8 | `operaciones` · 24 rutas con gate extra | `operaciones` |  |
